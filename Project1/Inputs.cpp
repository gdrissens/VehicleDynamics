...
void save_inputs(const Vehicle_inputs& vehicle_inputs, const std::string& file_name) {
    ...
    ostream << "m_u_fl" << '=' << vehicle_inputs.m_u_fl << '\n';
    ostream << "m_u_fr" << '=' << vehicle_inputs.m_u_fr << '\n';
    ostream << "m_u_rl" << '=' << vehicle_inputs.m_u_rl << '\n';
    ostream << "m_u_rr" << '=' << vehicle_inputs.m_u_rr << '\n';
	...
	ostream << "q_r_f_2" << '=' << vehicle_inputs.q_r_f_2 << '\n';
	ostream << "q_r_f_1" << '=' << vehicle_inputs.q_r_f_1 << '\n';
	ostream << "q_r_f_0" << '=' << vehicle_inputs.q_r_f_0 << '\n';
	...
	ostream << "q_r_r_2" << '=' << vehicle_inputs.q_r_r_2 << '\n';
	ostream << "q_r_r_1" << '=' << vehicle_inputs.q_r_r_1 << '\n';
	ostream << "q_r_r_0" << '=' << vehicle_inputs.q_r_r_0 << '\n';
	...
	ostream << "q_p_f_2" << '=' << vehicle_inputs.q_p_f_2 << '\n';
	ostream << "q_p_f_1" << '=' << vehicle_inputs.q_p_f_1 << '\n';
	ostream << "q_p_f_0" << '=' << vehicle_inputs.q_p_f_0 << '\n';
	...
	ostream << "q_p_r_2" << '=' << vehicle_inputs.q_p_r_2 << '\n';
	ostream << "q_p_r_1" << '=' << vehicle_inputs.q_p_r_1 << '\n';
	ostream << "q_p_r_0" << '=' << vehicle_inputs.q_p_r_0 << '\n';
...
bool load_inputs(Vehicle_inputs& vehicle_inputs, const std::string& file_name) {
    ...
    while (std::getline(file, line))
    {
        ...
        else if (name == "m_u_fl") vehicle_inputs.m_u_fl = std::stod(value);
        else if (name == "m_u_fr") vehicle_inputs.m_u_fr = std::stod(value);
        else if (name == "m_u_rl") vehicle_inputs.m_u_rl = std::stod(value);
        else if (name == "m_u_rr") vehicle_inputs.m_u_rr = std::stod(value);
        ...
        else if (name == "q_r_f_2") vehicle_inputs.q_r_f_2 = stod(value);
        else if (name == "q_r_f_1") vehicle_inputs.q_r_f_1 = stod(value);
        else if (name == "q_r_f_0") vehicle_inputs.q_r_f_0 = stod(value);
        ...
        else if (name == "q_r_r_2") vehicle_inputs.q_r_r_2 = stod(value);
        else if (name == "q_r_r_1") vehicle_inputs.q_r_r_1 = stod(value);
        else if (name == "q_r_r_0") vehicle_inputs.q_r_r_0 = stod(value);
        ...
        else if (name == "q_p_f_2") vehicle_inputs.q_p_f_2 = stod(value);
        else if (name == "q_p_f_1") vehicle_inputs.q_p_f_1 = stod(value);
        else if (name == "q_p_f_0") vehicle_inputs.q_p_f_0 = stod(value);
        ...
        else if (name == "q_p_r_2") vehicle_inputs.q_p_r_2 = stod(value);
        else if (name == "q_p_r_1") vehicle_inputs.q_p_r_1 = stod(value);
        else if (name == "q_p_r_0") vehicle_inputs.q_p_r_0 = stod(value);
