...
struct Vehicle_inputs {
	...
	double p_r_f_2, p_r_f_1, p_r_f_0; //Front instantaneous roll center height (function of roll angle)
	...
	double p_r_r_2, p_r_r_1, p_r_r_0; // Rear instantaneous roll center height (function of roll angle)
	...
	double p_p_f_2, p_p_f_1, p_p_f_0; // Front instantaneous pitch center height (function of pitch angle)
	...
	double p_p_r_2, p_p_r_1, p_p_r_0; // Rear instantaneous pitch center height (function of pitch angle)
